...
Find the data model created with MySQL Workbench (png and mwb files), png snapshots for every task and the SQL database in the folder: **`1. Database`**. Below are all the SQL statements used in the project after building the database from the data model.

...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `OrderDeliveryID` FOREIGN KEY (`OrderDeliveryID`) REFERENCES `orderdeliverystatus` (`OrderDeliveryID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2025-04-07 14:58:30
